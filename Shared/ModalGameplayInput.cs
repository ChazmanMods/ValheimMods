...
// Linked into each participating standalone mod. Each assembly guards its own modal state;
// Harmony composes these guards without requiring another Runic mod to be installed.
