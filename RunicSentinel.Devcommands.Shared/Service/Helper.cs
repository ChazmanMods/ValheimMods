...
{
  public static bool IsValid(ZoneSystem.ZoneLocation loc) => loc != null && loc.m_prefab != null && loc.m_prefab.IsValid;
  ...
  public static bool? IsDown(string key)
  {
    ...
    if (key.StartsWith("-", StringComparison.OrdinalIgnoreCase))
      return Enum.TryParse<KeyCode>(key.Substring(1), true, out var code) ? !UnityEngine.Input.GetKey(code) : null;
    else
      return Enum.TryParse<KeyCode>(key, true, out var code) ? UnityEngine.Input.GetKey(code) : null;
#endif
  }
