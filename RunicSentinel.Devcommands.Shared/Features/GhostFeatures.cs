...
public class GhostFeatures
{
  ...
  private static IEnumerable<CodeInstruction> ReplacePlayers(IEnumerable<CodeInstruction> instructions)
  {
    return new CodeMatcher(instructions)
         .MatchStartForward(
             new CodeMatch(OpCodes.Ldsfld, typeof(Player).GetField(nameof(Player.s_players),System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.NonPublic|System.Reflection.BindingFlags.Static|System.Reflection.BindingFlags.Instance)))
         .SetAndAdvance(
