...
public class FlyFeatures
{
  ...
  {
    return new CodeMatcher(instructions)
     .MatchStartForward(new CodeMatch(OpCodes.Ldfld, typeof(GameCamera).GetField(nameof(GameCamera.m_freeFlyYaw),System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.NonPublic|System.Reflection.BindingFlags.Static|System.Reflection.BindingFlags.Instance)))
     .Advance(-2)
     .InsertAndAdvance(
         new CodeInstruction(OpCodes.Ldloc_0),
         new CodeInstruction(OpCodes.Call, typeof(FlyFeatures).GetMethod(nameof(CheckInvert),System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.NonPublic|System.Reflection.BindingFlags.Static|System.Reflection.BindingFlags.Instance)),
  ...
  private static float WaterDistance(GameCamera camera)=>NoClipCameraEnabled()?float.MinValue:camera.m_minWaterDistance;
  ...
  static IEnumerable<CodeInstruction> GetCameraPositionTranspiler(IEnumerable<CodeInstruction> instructions)
  {
    return new CodeMatcher(instructions)
         .MatchStartForward(
             new CodeMatch(OpCodes.Ldfld, typeof(GameCamera).GetField(nameof(GameCamera.m_minWaterDistance),System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.NonPublic|System.Reflection.BindingFlags.Static|System.Reflection.BindingFlags.Instance)))
         .Repeat(matcher => matcher
           .SetAndAdvance(
             OpCodes.Call,
             Transpilers.EmitDelegate(
                 WaterDistance).operand)
         )
         .InstructionEnumeration();
  }
