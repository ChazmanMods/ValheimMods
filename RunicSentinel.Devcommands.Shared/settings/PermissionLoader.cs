...
public class PermissionLoader
{
  ...
  public static string FileName = "RunicSentinel.commands.permissions.yaml";
  ...
  public static void CreateFile()
  {
    ...
    // Sentinel requires authenticated administrator rights before the permissions editor can execute.
    entry.commands = [];
    ToFile();
  }
