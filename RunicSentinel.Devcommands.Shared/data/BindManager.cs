...
{
  public static string Pattern = "RunicSentinel.binds*.yaml";
  public static string Folder = "RunicSentinel.binds";
  public const string DefaultFile = "RunicSentinel.binds.yaml";
  ...
  public static bool GetKey(KeyCode key)
  {
    ...
    if (key == KeyCode.Mouse5) return UnityEngine.Input.GetKey(KeyCode.Mouse5);
    if (key == KeyCode.Mouse6) return UnityEngine.Input.GetKey(KeyCode.Mouse6);
