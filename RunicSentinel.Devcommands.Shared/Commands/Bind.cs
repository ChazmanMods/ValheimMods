...
public class BindCommand
{
  ...
  static IEnumerable<CodeInstruction> DisableDefaultBindExecution(IEnumerable<CodeInstruction> instructions)
  {
    return new CodeMatcher(instructions)
         .MatchStartForward(new CodeMatch(OpCodes.Stfld, typeof(Chat).GetField(nameof(Chat.m_wasFocused),System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.NonPublic|System.Reflection.BindingFlags.Static|System.Reflection.BindingFlags.Instance)))
        .Advance(4)
