...
public class TeleportCommand
{
  public TeleportCommand()
  {
    ...
    Helper.Command("tp", "[player1,player2,...] [x,z,y,rot/player] [fast=false] - Teleports the player to coordinates or another player.", (args) =>
    {
      ...
      if(Player.m_localPlayer==null&&RedirectOutput.Target!=null)
      {
        var requester=ZNet.instance.GetPeer(RedirectOutput.Target);
        if(requester!=null)pos=requester.m_refPos;
      }
      if (args.Length > 2)
      {
