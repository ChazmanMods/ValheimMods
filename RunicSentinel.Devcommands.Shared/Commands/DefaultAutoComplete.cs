...
public static class DefaultAutoComplete
{
  public static void Register()
  {
    ...
    AutoComplete.Register("spawn", index =>
    {
      ...
      if (index == 3) return ParameterInfo.Create("Radius in metres", "default 0.5; p/e/i may also follow the numeric arguments");
      if (index == 4) return new(){"p","e","i"};
      if (index == 5) return ParameterInfo.Create("Optional Component.field::value overrides");
      return ParameterInfo.None;
    });
