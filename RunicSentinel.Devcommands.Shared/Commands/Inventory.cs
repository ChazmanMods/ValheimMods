...
{
  private static readonly List<string> Operations = ["clear", "level", "refill", "repair", "upgrade"];
  private static readonly List<string> Targets = ["all", "hand", "worn"];
  private static readonly HashSet<ItemDrop.ItemData.ItemType> HandTypes = [
  ...
  private static readonly HashSet<ItemDrop.ItemData.ItemType> ArmorTypes = [
  ...
  public InventoryCommand()
  {
    ...
    AutoComplete.Register("inventory", index =>
    {
