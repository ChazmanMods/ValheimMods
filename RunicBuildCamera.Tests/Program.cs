...
namespace RunicBuildCamera.Tests
{
    internal static class Program
    {
        private static int Main()
        {
            ...
            DemisterContractTests.Register();
            ...
            System.Console.WriteLine(
                TestRunner.FailureCount == 0
                    ? $"PASS: {TestRunner.PassCount}/{TestRunner.TotalCount} Runic Build Camera tests"
                    : $"FAIL: {TestRunner.FailureCount}/{TestRunner.TotalCount} Runic Build Camera tests failed");
